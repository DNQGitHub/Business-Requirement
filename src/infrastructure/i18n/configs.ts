export default {
	...
	// fall back from Dutch to English
	fallbacks: { nl: 'en' },
	...
	logDebugFn: function (msg: any) {
		process.env.DEBUG === 'false' || console.log('debug', msg);
	},

	// setting of log level WARN - default to require('debug')('i18n:warn')
	logWarnFn: function (msg: any) {
		process.env.DEBUG === 'false' || console.log('warn', msg);
	},

	// setting of log level ERROR - default to require('debug')('i18n:error')
	logErrorFn: function (msg: any) {
		process.env.DEBUG === 'false' || console.log('error', msg);
	},
